...
<div class="form-group{{ $errors->has('desc') ? 'has-error' : ''}}">
    ...
    {!! Form::textarea('desc', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    {!! $errors->first('desc', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('contact_no') ? 'has-error' : ''}}">
    {!! Form::label('contact_no', 'Contact No', ['class' => 'control-label']) !!}
    {!! Form::text('contact_no', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    {!! $errors->first('contact_no', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group{{ $errors->has('alt_contact_no') ? 'has-error' : ''}}">
    {!! Form::label('alt_contact_no', 'Alt Contact No', ['class' => 'control-label']) !!}
    {!! Form::text('alt_contact_no', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('gst_no') ? 'has-error' : ''}}">
    {!! Form::label('gst_no', 'Gst No', ['class' => 'control-label']) !!}
    {!! Form::text('gst_no', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
